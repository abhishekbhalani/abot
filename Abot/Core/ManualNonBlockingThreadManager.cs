...
namespace Abot.Core
{
    public class ManualNonBlockingThreadManager : IThreadManager
    {
        static ILog _logger = LogManager.GetLogger(typeof(ManualNonBlockingThreadManager).FullName);
        ...
        public ManualNonBlockingThreadManager(int maxThreads)
        {
